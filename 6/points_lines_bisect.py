...
class Belonging():
    ...
    def __init__(self, lines):
        self.a, self.b = map(sorted, zip(*lines))

    def bel_number(self, point):
        # Find the index of the most right segment with the start less or equal to our point
        right = bisect.bisect_right(self.a, point)
        # Find the index of the most left segment with the end greater or equal to our point
        left = bisect.bisect_left(self.b, point)
        return right - left
